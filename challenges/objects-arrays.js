...
let universities = [];
  graduates.forEach(uname => universities.push(uname.university));
...
*/
const animalNames = [];
  zooAnimals.forEach(zooName => animalNames.push('Nane: ' + zooName.animal_name + ' Scientific: ' + zooName.scientific_name));
